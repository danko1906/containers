...
async function refreshAccessToken() {
    ...
    const response = await fetch("http://192.168.2.101:5001/api/auth/refresh", {
        method: "POST",
        headers: {
...
document.getElementById("loginForm").addEventListener("submit", async function (event) {
    ...
    const response = await fetch("http://192.168.2.101:5001/api/auth/token", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
document.getElementById("registerForm").addEventListener("submit", async function (event) {
    ...
    const response = await fetch("http://192.168.2.101:5001/api/auth/register", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
async function checkTokenValidity() {
    ...
    const response = await fetch("http://192.168.2.101:5001/api/protected", {
        method: "GET",
        headers: {
